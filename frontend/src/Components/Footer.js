    ...
    return (
        <div className='footer'>
            ...
            <div className="developer-info">
                ...
                <p>
                    <span>Developed by : Akash Kumar | </span>
                    <Link to={process.env.REACT_APP_PORTFOLIO_URL} target='_blank'>About Us</Link>
                    <span> | </span>
                    <Link to={process.env.REACT_APP_LINKEDIN_URL} target='_blank'>Contact Us</Link>
                </p>
            </div>
        </div>
    );
